<legend class="heading">Добавить ресурс</legend>

<?php echo if isset($exception_msg) ?>
<div>Ошибка: <?php echo $exception_msg ?></div><br/>
<?php endif ?>

<form class="form-horizontal" class="form-horizontal" action="<?php echo $this->url(array('controller' => 'user','action' => 'addResource')); ?>" method="post">
    <table>
        <tr>
